...
{
    defineTypeNameAndDebug(scaledPowerLaw, 0);
...
Foam::laminarModels::generalisedNewtonianViscosityModels::scaledPowerLaw::scaledPowerLaw
(
...
bool Foam::laminarModels::generalisedNewtonianViscosityModels::scaledPowerLaw::read
(
    const dictionary& viscosityProperties
)
{
...
Foam::laminarModels::generalisedNewtonianViscosityModels::scaledPowerLaw::
nu
(
